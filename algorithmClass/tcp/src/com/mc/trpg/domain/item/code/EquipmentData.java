package com.mc.trpg.item.code;

import com.mc.trpg.item.Equipment;
import com.mc.trpg.item.Slot;
...
public enum EquipmentData {
    ...
    KATANA("카타나", 30, 1, Slot.WEAPON, "샥샥"),

    WOOD_ARMOR("나무갑옷", 1, 10, Slot.ARMOR, ""),
    WOOD_BOOTS("나무부츠", 1, 5, Slot.BOOTS, ""),
    STONE_ARMOR("돌갑옷", 1, 20, Slot.ARMOR, "");
