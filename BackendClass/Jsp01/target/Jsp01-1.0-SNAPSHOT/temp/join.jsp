...
<div id="wrap">
    ...
    <form name="frmJoin" method="post" action="joinOk.jsp">
        <table>
            ...
            <tr>
                <td>비밀번호</td>
                <td><input type="password" id="pwd" name="pw"></td>
            </tr>
            <tr>
                <td>휴대폰 번호</td>
                <td><input type="text" id="hp1" size="3" name="hp1">
                    - <input type="text" id="hp2" size="4" name="hp2">
                    - <input type="text" id="hp3" size="4" name="hp3"></td>
            </tr>
            <tr>
                <td>학년</td>
                <td><input type="radio" value="1" name="grade">1학년
                    <input type="radio" id="year2" value="2" name="grade">2학년
                    <input type="radio" id="year3" value="3" name="grade">3학년
                    <input type="radio" id="year4" value="4" name="grade">4학년
                </td>
            </tr>
            <tr>
                <td>관심분야</td>
                <td><input type="checkbox" id="web" value="웹" name="interests">웹 프로그래밍
                    ...
                    <input type="checkbox" id="java" value="자바" name="interests">자바 프로그래밍
                </td>
            </tr>
            <tr>
                <td>학과</td>
