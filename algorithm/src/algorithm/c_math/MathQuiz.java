...
public class MathQuiz {
    public static void main(String[] args) {
        ...
        System.out.printf("소수 입니까? : %s \n", isPrime2(11));
        System.out.printf("12, 18의 최대공약수 : %d \n", gcd2(12, 18));
        System.out.printf("12, 18의 최소 공배수: %d \n", lcm(12, 18));
        System.out.printf("5! : %d \n", factorial(5));
        System.out.printf("5! : %d \n", factorialTail(5, 1));
    }

    private static int factorial(int i) {
        if (i < 0) throw new IllegalArgumentException("음수입니다.");
        // if(i == 0)
        if (i <= 1) return 1;
        return i * factorial(i - 1);
    }

    // 자바는 꼬리재귀(반환부에 연산이 없는 재귀함수)를 지원하지 않아서 재귀 함수 사용 x
    ...
    // a > b
    // a 와 b 가 최대공약수 G 를 가질 때, a를 b로 나눈 나머지는 G의 배수이다.
    // a = MG
    // b = NG
    // a = bq + r (q: 몫, r: 나머지)
    // MG = NGq + r
