...
//	}
    ...
    // 카테고리별 상품 조회
    @GetMapping("/product/productCtgList/{ctgId}")
    ...
    public String insertProduct(ProductVO vo) {
        ...
        //프론트컨트롤러가 반환받아서 redirect: 뒤의 uri로 요청을 하도록 브라우저에 응답신호 보냄
        //return "product/productListView";//뷰페이지는 출력되지만 데이터 표현되지 않음
    }
