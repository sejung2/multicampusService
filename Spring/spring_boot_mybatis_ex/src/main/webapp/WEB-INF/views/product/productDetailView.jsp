...
<div id="wrap">
    ...
    <form method="post" action="<c:url value='/product/insertCart'/>">
        <table border="1" width="900">
            <tr>
                <td rowspan="9"><img src="<c:url value='/product_images/${prd.prdImg}'/>" width="300" height="250"></td>
            </tr>
            <tr>
                <td>상품번호</td>
                <td>
            ...
            <tr>
                <td>가격</td>
                <td><span id="price" data-price="${prd.prdPrice}"><!-- 상품가격을 추출해서 js 이용 구매예정금액 계산 -->
