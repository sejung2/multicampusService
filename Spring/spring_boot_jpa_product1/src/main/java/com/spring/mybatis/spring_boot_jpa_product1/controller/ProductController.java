package com.spring.mybatis.spring_boot_jpa_product1.controller;

import com.spring.mybatis.spring_boot_jpa_product1.dto.ProductDTO;
import com.spring.mybatis.spring_boot_jpa_product1.service.ProductService;
...
//	}
	...
	@ResponseBody
	@RequestMapping("/product/productSearch1")
	public List<ProductDTO> productSearch1(@RequestParam HashMap<String, String > param) {
		ArrayList<ProductDTO> prdList = productService.productSearch(param);
		return prdList;
	}
